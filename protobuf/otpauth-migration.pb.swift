...
struct OtpMigration: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var accounts: [OtpMigration.Account] = []
  ...
  enum Algorithm: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    static let allCases: [OtpMigration.Algorithm] = [
      .unspecified,
      .sha1,
      .sha256,
      .sha512,
  ...
  enum Digits: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [OtpMigration.Digits] = [
      .unspecified,
      .six,
      .eight,
    ]
  ...
  enum OtpType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [OtpMigration.OtpType] = [
      .unspecified,
      .hotp,
      .totp,
    ]
  ...
  struct Account: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var algorithm: OtpMigration.Algorithm = .unspecified

    var digits: OtpMigration.Digits = .unspecified

    var type: OtpMigration.OtpType = .unspecified
...
extension OtpMigration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "OtpMigration"
  ...
  static func ==(lhs: OtpMigration, rhs: OtpMigration) -> Bool {
...
extension OtpMigration.Algorithm: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension OtpMigration.Digits: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "DIGITS_UNSPECIFIED"),
    1: .same(proto: "DIGITS_SIX"),
    2: .same(proto: "DIGITS_EIGHT"),
  ]
}

extension OtpMigration.OtpType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension OtpMigration.Account: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = OtpMigration.protoMessageName + ".Account"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "secret"),
    2: .same(proto: "name"),
    3: .same(proto: "issuer"),
  ...
  static func ==(lhs: OtpMigration.Account, rhs: OtpMigration.Account) -> Bool {
